package com.xbox.launcher.ui.theme
...
// Dedicated Segoe UI Light font family for the large pivot header
val SegoeUILightFontFamily = FontFamily(
    Font(R.font.segoe_ui_light, FontWeight.Light),
    Font(R.font.segoe_ui_light, FontWeight.Thin)
)
